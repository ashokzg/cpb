"""autogenerated by genpy from billiards_msgs/GetTableStateAction.msg. Do not edit."""
import sys
...
class GetTableStateAction(genpy.Message):
  _md5sum = "8a44f00c2974affb47b3b485fd041dc8"
  _type = "billiards_msgs/GetTableStateAction"
...
"""
  ...
  _slot_types = ['billiards_msgs/GetTableStateActionGoal','billiards_msgs/GetTableStateActionResult','billiards_msgs/GetTableStateActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetTableStateAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = billiards_msgs.msg.GetTableStateActionGoal()
      if self.action_result is None:
        self.action_result = billiards_msgs.msg.GetTableStateActionResult()
      if self.action_feedback is None:
        self.action_feedback = billiards_msgs.msg.GetTableStateActionFeedback()
    else:
      self.action_goal = billiards_msgs.msg.GetTableStateActionGoal()
      self.action_result = billiards_msgs.msg.GetTableStateActionResult()
      self.action_feedback = billiards_msgs.msg.GetTableStateActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.table_frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.filter_against_table, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.state.balls)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.state.balls:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.table_frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.table_frame_id = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.action_goal.goal.filter_against_table, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_goal.goal.filter_against_table = bool(self.action_goal.goal.filter_against_table)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.state.balls = []
      for i in range(0, length):
        ...
        self.action_result.result.state.balls.append(val1)
      _x = self
      start = end
      end += 12
