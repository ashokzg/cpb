"""autogenerated by genpy from billiards_msgs/LocalizeTableAction.msg. Do not edit."""
import sys
...
class LocalizeTableAction(genpy.Message):
  _md5sum = "1e42cda806268aee968f43bde93f52a3"
  _type = "billiards_msgs/LocalizeTableAction"
...
"""
  ...
  _slot_types = ['billiards_msgs/LocalizeTableActionGoal','billiards_msgs/LocalizeTableActionResult','billiards_msgs/LocalizeTableActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalizeTableAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = billiards_msgs.msg.LocalizeTableActionGoal()
      if self.action_result is None:
        self.action_result = billiards_msgs.msg.LocalizeTableActionResult()
      if self.action_feedback is None:
        self.action_feedback = billiards_msgs.msg.LocalizeTableActionFeedback()
    else:
      self.action_goal = billiards_msgs.msg.LocalizeTableActionGoal()
      self.action_result = billiards_msgs.msg.LocalizeTableActionResult()
      self.action_feedback = billiards_msgs.msg.LocalizeTableActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.action_result.result.pose.pose.position.x, _x.action_result.result.pose.pose.position.y, _x.action_result.result.pose.pose.position.z, _x.action_result.result.pose.pose.orientation.x, _x.action_result.result.pose.pose.orientation.y, _x.action_result.result.pose.pose.orientation.z, _x.action_result.result.pose.pose.orientation.w))
      _x = self.action_result.result.child_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.pose.pose.position.x, _x.action_result.result.pose.pose.position.y, _x.action_result.result.pose.pose.position.z, _x.action_result.result.pose.pose.orientation.x, _x.action_result.result.pose.pose.orientation.y, _x.action_result.result.pose.pose.orientation.z, _x.action_result.result.pose.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.child_frame = str[start:end].decode('utf-8')
      else:
        self.action_result.result.child_frame = str[start:end]
      _x = self
      start = end
      end += 12
