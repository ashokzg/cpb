"""autogenerated by genpy from billiards_msgs/LocalizeTableResult.msg. Do not edit."""
import sys
...
class LocalizeTableResult(genpy.Message):
  _md5sum = "ffb546346c53cf7343fc48bde3958c7b"
  _type = "billiards_msgs/LocalizeTableResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalizeTableResult, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.child_frame = str[start:end].decode('utf-8')
      else:
