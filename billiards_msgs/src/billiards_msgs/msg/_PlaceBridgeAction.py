"""autogenerated by genpy from billiards_msgs/PlaceBridgeAction.msg. Do not edit."""
import sys
...
class PlaceBridgeAction(genpy.Message):
  _md5sum = "de990ba2b975e268eb0b33744b702252"
  _type = "billiards_msgs/PlaceBridgeAction"
...
"""
  ...
  _slot_types = ['billiards_msgs/PlaceBridgeActionGoal','billiards_msgs/PlaceBridgeActionResult','billiards_msgs/PlaceBridgeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaceBridgeAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = billiards_msgs.msg.PlaceBridgeActionGoal()
      if self.action_result is None:
        self.action_result = billiards_msgs.msg.PlaceBridgeActionResult()
      if self.action_feedback is None:
        self.action_feedback = billiards_msgs.msg.PlaceBridgeActionFeedback()
    else:
      self.action_goal = billiards_msgs.msg.PlaceBridgeActionGoal()
      self.action_result = billiards_msgs.msg.PlaceBridgeActionResult()
      self.action_feedback = billiards_msgs.msg.PlaceBridgeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.down, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.down, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_goal.goal.down = bool(self.action_goal.goal.down)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
