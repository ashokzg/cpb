"""autogenerated by genpy from billiards_msgs/PlaceBridgeActionResult.msg. Do not edit."""
import sys
...
class PlaceBridgeActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "billiards_msgs/PlaceBridgeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/PlaceBridgeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaceBridgeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = billiards_msgs.msg.PlaceBridgeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = billiards_msgs.msg.PlaceBridgeResult()
