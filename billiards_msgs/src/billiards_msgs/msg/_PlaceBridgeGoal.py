"""autogenerated by genpy from billiards_msgs/PlaceBridgeGoal.msg. Do not edit."""
import sys
...
class PlaceBridgeGoal(genpy.Message):
  _md5sum = "eb0ebaa46030099569244fecb945e17e"
  _type = "billiards_msgs/PlaceBridgeGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlaceBridgeGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3I.pack(_x.down, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.down, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
