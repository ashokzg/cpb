"""autogenerated by genpy from billiards_msgs/PlanShotActionFeedback.msg. Do not edit."""
import sys
...
class PlanShotActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "billiards_msgs/PlanShotActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/PlanShotFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanShotActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = billiards_msgs.msg.PlanShotFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = billiards_msgs.msg.PlanShotFeedback()
