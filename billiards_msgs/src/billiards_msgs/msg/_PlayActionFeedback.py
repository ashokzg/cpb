"""autogenerated by genpy from billiards_msgs/PlayActionFeedback.msg. Do not edit."""
import sys
...
class PlayActionFeedback(genpy.Message):
  ...
  _type = "billiards_msgs/PlayActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/PlayFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = billiards_msgs.msg.PlayFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = billiards_msgs.msg.PlayFeedback()
