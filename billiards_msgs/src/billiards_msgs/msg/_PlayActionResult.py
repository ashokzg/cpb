"""autogenerated by genpy from billiards_msgs/PlayActionResult.msg. Do not edit."""
import sys
...
class PlayActionResult(genpy.Message):
  ...
  _type = "billiards_msgs/PlayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/PlayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = billiards_msgs.msg.PlayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = billiards_msgs.msg.PlayResult()
