"""autogenerated by genpy from billiards_msgs/PoseStampedToTFAction.msg. Do not edit."""
import sys
...
class PoseStampedToTFAction(genpy.Message):
  _md5sum = "24befe55a5655aa69a96256b986d2bfe"
  _type = "billiards_msgs/PoseStampedToTFAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

PoseStampedToTFActionGoal action_goal
PoseStampedToTFActionResult action_result
PoseStampedToTFActionFeedback action_feedback

================================================================================
MSG: billiards_msgs/PoseStampedToTFActionGoal
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalID goal_id
PoseStampedToTFGoal goal
...
================================================================================
MSG: billiards_msgs/PoseStampedToTFGoal
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: billiards_msgs/PoseStampedToTFActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
PoseStampedToTFResult result
...
================================================================================
MSG: billiards_msgs/PoseStampedToTFResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

================================================================================
MSG: billiards_msgs/PoseStampedToTFActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
PoseStampedToTFFeedback feedback

================================================================================
MSG: billiards_msgs/PoseStampedToTFFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======


"""
  __slots__ = ['action_goal','action_result','action_feedback']
  _slot_types = ['billiards_msgs/PoseStampedToTFActionGoal','billiards_msgs/PoseStampedToTFActionResult','billiards_msgs/PoseStampedToTFActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseStampedToTFAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = billiards_msgs.msg.PoseStampedToTFActionGoal()
      if self.action_result is None:
        self.action_result = billiards_msgs.msg.PoseStampedToTFActionResult()
      if self.action_feedback is None:
        self.action_feedback = billiards_msgs.msg.PoseStampedToTFActionFeedback()
    else:
      self.action_goal = billiards_msgs.msg.PoseStampedToTFActionGoal()
      self.action_result = billiards_msgs.msg.PoseStampedToTFActionResult()
      self.action_feedback = billiards_msgs.msg.PoseStampedToTFActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.child_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.child_frame = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.child_frame = str[start:end]
      _x = self
      start = end
      end += 12
