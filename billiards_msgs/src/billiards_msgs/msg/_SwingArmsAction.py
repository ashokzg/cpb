"""autogenerated by genpy from billiards_msgs/SwingArmsAction.msg. Do not edit."""
import sys
...
class SwingArmsAction(genpy.Message):
  _md5sum = "99444920763683a384cd94942edcab53"
  _type = "billiards_msgs/SwingArmsAction"
...
"""
  ...
  _slot_types = ['billiards_msgs/SwingArmsActionGoal','billiards_msgs/SwingArmsActionResult','billiards_msgs/SwingArmsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwingArmsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = billiards_msgs.msg.SwingArmsActionGoal()
      if self.action_result is None:
        self.action_result = billiards_msgs.msg.SwingArmsActionResult()
      if self.action_feedback is None:
        self.action_feedback = billiards_msgs.msg.SwingArmsActionFeedback()
    else:
      self.action_goal = billiards_msgs.msg.SwingArmsActionGoal()
      self.action_result = billiards_msgs.msg.SwingArmsActionResult()
      self.action_feedback = billiards_msgs.msg.SwingArmsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2i3I.pack(_x.action_goal.goal.away, _x.action_goal.goal.initial_wait.secs, _x.action_goal.goal.initial_wait.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.away, _x.action_goal.goal.initial_wait.secs, _x.action_goal.goal.initial_wait.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_B2i3I.unpack(str[start:end])
      self.action_goal.goal.away = bool(self.action_goal.goal.away)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
