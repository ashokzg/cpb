"""autogenerated by genpy from billiards_msgs/SwingArmsActionFeedback.msg. Do not edit."""
import sys
...
class SwingArmsActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "billiards_msgs/SwingArmsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/SwingArmsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwingArmsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = billiards_msgs.msg.SwingArmsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = billiards_msgs.msg.SwingArmsFeedback()
