"""autogenerated by genpy from billiards_msgs/SwingArmsActionResult.msg. Do not edit."""
import sys
...
class SwingArmsActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "billiards_msgs/SwingArmsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','billiards_msgs/SwingArmsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwingArmsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = billiards_msgs.msg.SwingArmsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = billiards_msgs.msg.SwingArmsResult()
